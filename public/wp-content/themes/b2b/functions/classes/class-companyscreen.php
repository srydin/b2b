...
class CompanyScreen extends WP_List_Table {
    ...
    public function __construct() {
        ...
        parent::__construct( [
            'singular' => __( '', self::$singular_name ), //singular name of the listed records
    ...
    public static function get_companies( $per_page = 5, $page_number = 1 ) {
        ...
        $sql = "SELECT * FROM " . Company::$table_name;
