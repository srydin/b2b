<?php wp_footer(); // WP stuff ?>
<footer class="text-center pad-3">
    <svg id="footer-logo" width="150px" height="36px">
    ...
    <nav>
        <ul>
            <li><a class="blue" href="">Privacy Policy</a></li>
            <li><a class="blue" href="">Terms of Use</a></li>
...
<script>
    // var observer=lozad();observer.observe();observer.observe();
    $(window).bind("load", function () {
        $("#mobile-menu").click(function () {
            $("nav").toggleClass("show").animate({top: "70px", opacity: "1", padding: "1.414em 1em"});
            $("#mobile-menu").toggleClass("open")
        });
        $(document).ready(function () {
            -1 != window.location.href.indexOf("#join") && $("#join").modal("show")
        });
        ...
        $("#category-select").autocomplete({
            ...
            minLength: 0, select: function (a, b) {
                a.preventDefault();
                location.href = b.item.value
            }
        }).focus(function () {
