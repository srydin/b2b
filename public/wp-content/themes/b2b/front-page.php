<?php get_header(); ?>
    ...
    <section id="top-banner" class="pad-3 dark-blue-bg">
        ...
        <div id="form-wrapper" class="pad-1 h-pad-0 sm-text-wrapper text-center">
            <input id="category-select" class="sm-text-1 pad-2 white w-500" placeholder="Select a category" type="text">
            <button class="text-1 w-700 white benton">Find Solutions <svg class="sm-pad-2 v-pad-0" width="7px" height="12px">
    ...
    <section id="who-we-are" class="pad-3 divided">
        ...
        <p class="sm-text-wrapper text-1 sm-pad-1 h-pad-0 w-400 text-center">Cras semper id mauris feugiat tincidunt. Fusce
            ac massa molestie, laoreet felis non, tincidunt elit. Aenean metus quam, tincidunt suscipit mi non viverra dunt
            suscipit min.</p>
        </div>
    </section>
    <section id="business-categories" class="pad-4 h-pad-0 divided">
        <h2 class="xs-text-wrapper text-3 sm-pad-2 w-400 text-center benton">Helping businesses make better decisions</h2>
        <a style="margin-bottom:2.827em" class="text-1 w-500 text-center sm-pad-3 h-pad-0 blue underline block benton"
        ...
        <ul id="category-loop" class="benton lg-text-wrapper pad-3 v-pad-0">
            <li class="shadow-2x w-500 text-1">
            ...
            <li class="shadow-3x w-500 text-1">
                <a class="pad-1 v-pad-0 dark-blue" href="">Link name</a>
                <a class="sm-pad-1 green-bg">
                    <svg class="pad-2 v-pad-0" width="7px" height="12px">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    ...
    <section id="popular-articles" class="divided">
        <div class="pad-4">
            ...
            <a style="margin-bottom:0.707em" class="text-1 w-500 text-center sm-pad-3 h-pad-0 blue underline block benton"
               href="">Visit Knowledge Center</a>
        </div>
        <div class="article-module divided">
            ...
            <div class="blurb pad-3 lt-blue-bg">
                <div class="sm-text-wrapper">
                    ...
                    <p class="text-1 pad-1 h-pad-0 w-400">Cras semper id mauris feugiat tincidunt. Fusce ac massa molestie,
                        laoreet felis non, tincidunt elit. Aenean metus quam, tincidunt suscipit mi non.</p>
