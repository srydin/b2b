<?php get_header(); ?>
    ...
    <section id="business-categories" class="pad-4 divided">
        ...
        <a class="text-1 w-500 text-center sm-pad-3 h-pad-0 blue underline block benton" href="<?php echo $GLOBALS['site_url'];?>/knowledge-center">View All Categories</a>
        <ul id="featured-category-loop" class="benton lg-text-wrapper pad-3 v-pad-0">
            <li class="pad-1">
                <h3 class="green-bg pad-1"><a class="white" href="<?php echo $GLOBALS['site_url'];?>/crm-companies">CRM Software</a></h3>
                <picture>
            ...
            <li class="pad-1">
                <h3 class="green-bg pad-1"><a class="white" href="<?php echo $GLOBALS['site_url'];?>/accounting-software">Accounting Software</a></h3>
                <picture>
                    <source type="image/webp" srcset="wp-content/themes/b2b/assets/images/payroll-services.webp">
                    <source type="image/jpeg" srcset="wp-content/themes/b2b/assets/images/payroll-services.jpg">
                    <img src="wp-content/themes/b2b/assets/images/payroll-services.jpg">
    ...
    <section id="popular-articles" class="divided">
        <div class="pad-4">
            ...
            <a class="text-1 w-500 text-center sm-pad-3 h-pad-0 blue underline block benton" href="<?php echo $GLOBALS['site_url'];?>/knowledge-center">Visit Knowledge Center</a>
        </div>
        <div class="article-module divided">
            ...
            <div class="blurb pad-3 lt-blue-bg">
                <div class="sm-text-wrapper">
                    ...
                    <a class="inline blue pad-1 white-bg shadow-3x w-500 benton" href="<?php echo $GLOBALS['site_url'];?>/hello-world"><span class="pad-1 v-pad-0">Read Article</span></a>
                </div>
            </div>
        </div>
